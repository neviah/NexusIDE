...
header{display:flex;align-items:center;justify-content:space-between;padding:10px 12px;border-bottom:1px solid var(--vscode-sideBar-border,var(--vscode-widget-border))}h2{margin:0;font-size:13px}button{border:0;border-radius:3px;padding:5px 8px;color:var(--vscode-button-foreground);background:var(--vscode-button-background);cursor:pointer}.icon{width:28px;height:26px;padding:0;font-size:16px}.content{padding:10px 12px}.provider-select{display:grid;gap:5px;margin-bottom:10px;color:var(--vscode-descriptionForeground);font-size:11px}.provider-select select{width:100%;height:28px;color:var(--vscode-dropdown-foreground);background:var(--vscode-dropdown-background);border:1px solid var(--vscode-dropdown-border)}.status,.meta{color:var(--vscode-descriptionForeground);font-size:11px}.provider{padding:10px 0;border-top:1px solid var(--vscode-widget-border)}.provider-head{display:flex;align-items:start;justify-content:space-between;gap:8px}.provider-title{display:flex;align-items:center;gap:7px}.provider h3{margin:0;font-size:12px}.credential{display:flex;flex-wrap:wrap;gap:5px;margin-top:9px}.models{display:grid;gap:4px;margin-top:10px}.model{display:grid;grid-template-columns:auto minmax(0,1fr) auto;gap:7px;align-items:start;padding:4px 0}.model-copy{overflow-wrap:anywhere}.route-tools{display:flex;align-items:center;gap:2px}.order{width:18px;text-align:center;color:var(--vscode-descriptionForeground);font-size:11px}.route-tools button{width:24px;height:22px;padding:0}.quota-note{width:100%;margin-top:8px;padding:4px 6px;border:1px solid var(--vscode-input-border,var(--vscode-widget-border));color:var(--vscode-input-foreground);background:var(--vscode-input-background)}.footer{position:sticky;bottom:0;padding:10px 12px;border-top:1px solid var(--vscode-sideBar-border,var(--vscode-widget-border));background:var(--vscode-sideBar-background)}.footer button{width:100%}
</style></head><body><header><h2>Nexus Router</h2><button id="refresh" class="icon" title="Refresh providers" aria-label="Refresh providers">&#8635;</button></header><main class="content"><label class="provider-select">Provider<select id="provider" aria-label="Provider"></select></label><div id="content"><span class="status">Loading providers...</span></div></main><div class="footer"><button id="save">Save Auto Stack</button></div>
